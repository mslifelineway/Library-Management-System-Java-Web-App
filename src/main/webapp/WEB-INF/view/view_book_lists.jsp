                                                ...
                                                <c:when test="${ab.student.studentId=='0'}">
                                                    ...
                                                    <ul class="list-inline text-danger">
                                                        <li class="list-inline-item">
                                                            ...
                                                            <a href="${url_issue_book}" class="text-warning"><span class="badge badge-warning p-2">ISSUE BOOK</span></a>
                                                        </li>
                                                    </ul>
                                                </c:when>    
                                                <c:otherwise>
                                                    <s:url var="url_student_image" value="/static/images/${ab.student.profileImage}" />
                                                    ...
                                                    <ul class="list-inline text-danger">
                                                        <li class="list-inline-item">
                                                            <s:url var="url_student_profile" value="/student/view_profile">
                                                                <s:param name="studentId" value="${ab.student.studentId}"/>
                                                            </s:url>
                                                            <a class=" text-xs-center" href="${url_student_profile}">
                                                                <span class="badge badge-danger">View Profile</span>
                                                            </a>
                                                        </li>
                                                        <li class="list-inline-item">
                                                            <a class=" text-xs-center" href="#">
                                                                <span class="badge badge-warning">Return Book</span>
                                                            </a>
                                                        </li>
                                                    </ul>
                                                </c:otherwise>
